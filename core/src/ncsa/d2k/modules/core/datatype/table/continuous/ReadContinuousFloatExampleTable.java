...
public class ReadContinuousFloatExampleTable extends InputModule {
  ...
  public String getModuleInfo()
    {
    return "ReadContinuousFloatExampleTable";
    }
  ...
  public void doit() throws Exception
  {
    ...
    float [] data = new float[numExamples * numFeatures];
    ...
    for (int e = 0; e < NumRowsToRead; e++)
    {
      ...
      for (int i = 0; i < numInputs; i++)
        data[e * numFeatures + i] = (float) columnValues[inputColumnIndices[i]];
      for (int i = 0; i < numOutputs; i++)
        data[e * numFeatures + numInputs + i] = (float) columnValues[outputColumnIndices[i]];
    ...
    ContinuousFloatExampleTable exampleSet = new ContinuousFloatExampleTable(data, numExamples, numInputs, numOutputs, inputNames, outputNames);
