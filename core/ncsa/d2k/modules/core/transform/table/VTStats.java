...
public class VTStats extends ncsa.d2k.infrastructure.modules.ComputeModule {
	...
	*/
	public String getModuleInfo () {
		 ...
		 return "This module takes in a VerticalTable and computes basic stats for every NumericColumn. The results are outputed in a new VerticalTable with one row per original NumericColum and columns in the following order: <ol><li>NumericColumnsNames<li>Minimums<li>Maximums<li>Means<li>Standard Deviation<li>Skewness<li>Kurtosis</ol>";
  ...
  ///////////////////
	...
	VerticalTable data=(VerticalTable)pullInput(0);
	  ...
	  for(int k=0; k<data.getNumColumns(); k++){
	    ...
	    if (col instanceof NumericColumn){ 
			...
			//compute the stdev, skewness, and kurtosis
		  	...
		  	double skewness=sum_diff3/((n-1)*deviation*deviation*deviation);
		  	double kurtosis=sum_diff4/((n-1)*deviation*deviation*deviation*deviation);
			//System.out.println(sum_diff3);
			//System.out.println(sum_diff4);
		...
		VerticalTable stats=new VerticalTable(7);
