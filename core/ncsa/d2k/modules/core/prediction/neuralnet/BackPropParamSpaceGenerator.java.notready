...
"   longer than is practical.</ul>";
	...
	protected ParameterSpace getDefaultSpace(){
		...
		names[BackPropModel.ACTIVATION_FUNCTION]= "Activation Function";
		names[BackPropModel.UPDATE_FUNCTION]= "Training Method";
		names[BackPropModel.EPOCHS]= "Epochs";
		names[BackPropModel.SEED]= "Seed";
		names[BackPropModel.WEIGHT_INIT_RANGE]= "Weight Init Range";
		names[BackPropModel.LEARNING_RATE_FUNCTION]= 
												"Learning Rate Function";
		names[BackPropModel.INITIAL_LEARNING_RATE]= "Initial Learning Rate";
		names[BackPropModel.FINAL_LEARNING_RATE]= "Final Learning Rate";
		names[BackPropModel.HIDDEN_LAYERS]= "Number Hidden Layers";
		names[BackPropModel.NODES_IN_LAYER_01]= "Nodes In Layer 1";
		names[BackPropModel.NODES_IN_LAYER_02]= "Nodes In Layer 2";
		names[BackPropModel.NODES_IN_LAYER_03]= "Nodes In Layer 3";
		names[BackPropModel.NODES_IN_LAYER_04]= "Nodes In Layer 4";
