...
public class NaiveBayesParamSpaceGenerator extends AbstractParamSpaceGenerator {
  ...
  public PropertyDescription [] getPropertiesDescriptions () {
          ...
          pds[0] = new PropertyDescription (BIN_METHOD, "Binning Method",
                                            "The method to use for binning.  Select 0 to create bins"+
                                            " by weight, 1 to select the number of bins.");
          pds[1] = new PropertyDescription (ITEMS_PER_BIN, "Number of Items per bin",
                                            "When binning by weight, this is the number of items"+
                                            " that will go in each bin.");
