...
public class EMOVis
  ...
  private class EMOVisPane
    ...
    private JButton viewDecisionVariablesButton;
    private JButton viewGenesButton;
    ...
    public void initView(ViewModule vm) {
      ...
      viewDecisionVariablesButton = new JButton("View Decision Variables");
      viewDecisionVariablesButton.addActionListener(new AbstractAction() {
        public void actionPerformed(ActionEvent e) {
          pushOutput(currentPop, 1);
        }
      });
      viewGenesButton = new JButton("View Genes");
      viewGenesButton.addActionListener(new AbstractAction() {
        public void actionPerformed(ActionEvent e) {
          pushOutput(currentPop, 1);
        }
      });
      ...
      buttonPanel.add(viewDecisionVariablesButton);
      buttonPanel.add(viewGenesButton);
