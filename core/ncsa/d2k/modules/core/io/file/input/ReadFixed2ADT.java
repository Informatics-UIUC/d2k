...
public class ReadFixed2ADT extends ncsa.d2k.core.modules.InputModule
    
{
    ...
    */
    public String getOutputInfo(int index) {
		switch (index) {
			case 0: return "      an ADTree  containing summary data from the file   ";
			case 1: return " a Table containing metadata about the file";
			case 2: return "Contains row/column info on which fields were blank inthe read in file";
    ...
    */
    public String[] getOutputTypes() {
		String[] types = {"ncsa.d2k.modules.core.datatype.ADTree","ncsa.d2k.modules.core.datatype.table.Table","ncsa.d2k.modules.core.datatype.table.Table"};
		return types;
	}
