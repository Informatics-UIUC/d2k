...
public class CreateARFFParser extends InputModule {
    ...
    public String getModuleInfo() {
        ...
        s.append("</p><p>Limitations: The ARFF parser generated by this module does ");
        s.append("not translate the missing values designated by ? in the input into ");
        s.append("missing values in the D2K data representations. Instead, the ? is ");
        s.append("retained for string, nominal, and date fields, and the value 0 is used ");
        s.append("in numeric fields.  The parser performs only a ");
        s.append("minimal amount of validation and does not verify that ");
        s.append("the data instances contain acceptable attribute values.  The module is ");
        s.append("designed to read valid ARFF files, not to verify their correctness. ");
        s.append("The module cannot handle the sparse data representation introduced in ");
