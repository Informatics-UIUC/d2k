...
/**
   This module allows a user to choose the name of three files.  The UserView 
   ...
   will be displayed in the TextArea.  The path of the last file chosen 
   and a value for the Label are saved as properties of this module. 
   @author David Clutter
*/
public class Get3FileNames extends UIModule 
	 {
    ...
    */
    ...
    /**	
	Set the text to show in l0 in Get3FileView
    ...
    */	
    ...
    /**
       Get the text to show in l0 in Get3FileView
    ...
    */
    ...
    /**	
	Set the text to show in l1 in Get3FileView
    ...
    */	
    ...
    /**
       Get the text to show in l1 in Get3FileView
    ...
    */
    ...
    /**	
	Set the text to show in l2 in Get3FileView
    ...
    */	
    ...
    /**
       Get the text to show in l2 in Get3FileView
    ...
    */
    public String getModuleInfo() {
		return "<html>  <head>      </head>  <body>    This module allows the user to choose three files using file dialogs. The     absolute pathnames of the files are the output.  </body></html>";
	}
    ...
    */
    class Get3FileView extends JUserInputPane implements ActionListener {
	/** A label for file0 */
	protected JLabel l0;
	/** A text field to show the path to file0 */	
	protected DSJTextField tf0 = new DSJTextField(30);
	/** A button that brings up a FileDialog so the user can 
	    choose file0 */
	...
	/** The module that creates this view.  We need a reference to it 
	    so we can get and set its properties. */
	Get3FileNames parentModule;
	...
	*/		
	public void initView(ViewModule mod) {
	    super.initView(mod);
	    parentModule = (Get3FileNames)mod;
	    ...
	    // Add file0 stuff
	    // Try to get a label for file0 from Get3FileNames 
	    ...
	    // Add file1 stuff
	    // Try to get a label for file2 from Get3FileNames 
		...
		l2 = new JLabel("File2");
	    Constrain.setConstraints(p, l2, 0, 2, 2, 1, 
				     GridBagConstraints.NONE,
				     GridBagConstraints.WEST, 1, 1);
	    ...
	    Constrain.setConstraints(p, placeholder, 0, 3, 4, 1,
				     GridBagConstraints.HORIZONTAL,
				     GridBagConstraints.WEST, 4, 1);
	    add(p);
	}
	...
	/**
	   ...
	   Get3FileNames does not receive any inputs, so this method 
	   is not used.
	...
	*/
	...
	/**
	   When a button is pressed, display a file dialog.  Then save 
	   the path of the chosen file as a String in the appropriate 
	   text area.
