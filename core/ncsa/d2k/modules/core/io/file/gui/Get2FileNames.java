...
/**
	This module allows a user to choose the name of two files.  The 
	UserView is a simple Panel with three components for each file 
	to choose: a Label, a TextArea, and a Button.  When a Button is 
	pressed, a FileDialog will pop up, and the user can choose a file.  
	The name of the selected file will be displayed in the TextArea.  
	The path of the last file chosen and a value for the Label are 
	saved as properties of this module. 
	@author David Clutter
*/
public class Get2FileNames extends UIModule 
	 {
    ...
    */
    ...
    /**	
	Set the text to show in l0 in Get2FileView
    ...
    */	
    ...
    /**
       Get the text to show in l0 in Get2FileView
    ...
    */
    ...
    /**	
	Set the text to show in l1 in Get2FileView
    ...
    */	
    ...
    /**
       Get the text to show in l1 in Get2FileView
    ...
    */
    public String getModuleInfo() {
		return "<html>  <head>      </head>  <body>    This module allows the user to choose two files using file dialogs. The     absolute pathnames of the files are the outputs.  </body></html>";
	}
    ...
    */
    protected class Get2FileView extends JUserInputPane 
	...
	/** The module that creates this view.  We need a reference to 
	    it so we can get and set its properties. */
	Get2FileNames parentModule;
	...
	*/		
	public void initView(ViewModule mod) {
	    super.initView(mod);
	    parentModule = (Get2FileNames)mod;
	    ...
	    // Add file0 stuff
	    // Try to get a label for file0 from Get2FileNames 
	    ...
	    Constrain.setConstraints(p, placeholder, 0, 2, 4, 1, 
				     GridBagConstraints.HORIZONTAL,
	...
	/**
	   ...
	   Get2FileNames does not receive any inputs, so this method 
	   is not used.
