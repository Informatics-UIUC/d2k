...
public class GetFilteredRuleAssc extends UIModule
        {
  ...
  */
  ...
  protected void filterRules() {
    ...
    for (int ruleIdx = 0; ruleIdx < allRules.size(); ruleIdx ++) {
      ...
      if (aRule.confidence >= Double.valueOf(confidenceChosen.getText()).doubleValue()) {
