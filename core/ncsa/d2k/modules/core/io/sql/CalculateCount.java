...
public class CalculateCount extends ComputeModule
  ...
  String columnStr;
  // left most branch of the tree needs fully expanded
  ...
  protected void addArrayItems(int size, ArrayList[] preCube,
    ...
    //System.out.println("rule size is " + size);
    //System.out.println("pt1 is " + pt1);
    //System.out.println("pt2 is " + pt2);
    //System.out.println("pt3 is " + pt3);
    //System.out.println("pt4 is " + pt4);
    //System.out.println("pt5 is " + pt5);
    ...
    for (int x=0; x<currColumnList.size(); x++) {
      System.out.println(currColumnList.get(x));
    }
    System.out.println("Column Value List");
    for (int r=0; r<currMapArray.length; r++) {
      for (int s=0; s<currMapArray[r].size(); s++) {
        System.out.println (currMapArray[r].get(s));
      }
    }
    */
  }
  ...
  //protected void outputToFile(String inputStr) {
    //try {
      //fw.write(inputStr, 0, inputStr.length());
    //}
    //catch(IOException e) {
      //e.printStackTrace();
    //}
