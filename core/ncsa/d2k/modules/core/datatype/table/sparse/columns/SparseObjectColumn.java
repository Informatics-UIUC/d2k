 ...
 */
   ...
   */
    public void insertRow (Object newEntry, int pos) {
      ...
      switch(getType()){
	case ColumnTypes.BYTE_ARRAY:  newEntry = SparseByteArrayColumn.toByteArray(newEntry);
				      break;
	case ColumnTypes.CHAR_ARRAY:  newEntry = SparseCharArrayColumn.toCharArray(newEntry);
				      break;
	case ColumnTypes.STRING:  newEntry = SparseStringColumn.toStringObject(newEntry);
				      break;
      }
  ...
  */
  ...
  private void toComparableArray(Object[] array){
    ...
    private Object[] getValues(int[] validRows){
	  ...
	  else values[i] = getObject(validRows[i]);
