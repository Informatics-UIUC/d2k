 ...
 */
public class SparseMutableTable extends SparseTable implements MutableTable {
 ...
 protected void addRow( int[] newEntry, int position, int[] validColumns){
  if(numRows <= position) numRows = position +1;
 ...
 */
   ...
   */
  protected void addColumn(byte[][] newEntry, int colIndex, int[] validRows){
    SparseByteArrayColumn baColumn = new SparseByteArrayColumn(newEntry, validRows);
   ...
   */
  protected void addColumn(char[][] newEntry, int colIndex, int[] validRows){
    SparseCharArrayColumn caColumn = new SparseCharArrayColumn(newEntry, validRows);
...
*/
 ...
 /**
   ...
   */
	...
	retVal.setColumn(cols[i] ,  ((AbstractSparseColumn)((AbstractSparseColumn)getColumn(cols[i])).reorderRows(newOrder)) );
 ...
 */
  public void sortByColumn(int col) {
    ...
    if(sorting != null)   sorting.sort(this);
  }
 ...
 public void addColumn(AbstractSparseColumn newColumn){
  ...
  public void addColumn(int newColIndex, int type, int size){
    ...
    switch(type){
      ...
      case ColumnTypes.BOOLEAN :  newCol = new SparseBooleanColumn(size);
				  break;

      case ColumnTypes.BYTE :  newCol = new SparseByteColumn(size);
				  break;

      case ColumnTypes.CHAR :  newCol = new SparseCharColumn(size);
				  break;

      case ColumnTypes.BYTE_ARRAY :  newCol = new SparseByteArrayColumn(size);
				  break;

      case ColumnTypes.INTEGER :  newCol = new SparseIntColumn(size);
				  break;

      case ColumnTypes.DOUBLE :  newCol = new SparseDoubleColumn(size);
				  break;

      case ColumnTypes.CHAR_ARRAY :  newCol = new SparseCharArrayColumn(size);
				  break;

      case ColumnTypes.LONG :  newCol = new SparseLongColumn(size);
				  break;
      case ColumnTypes.FLOAT :  newCol = new SparseFloatColumn(size);
				  break;

      case ColumnTypes.SHORT :  newCol = new SparseShortColumn(size);
				  break;

      case ColumnTypes.STRING :  newCol = new SparseStringColumn(size);
				  break;

      case ColumnTypes.OBJECT :  newCol = new SparseObjectColumn(size);
				  break;
    }//switch

    columns.put(newColIndex, newCol);

    if(newColIndex >= numColumns) numColumns = newColIndex + 1;
  }//addColumn
  ...
  protected void setColumn(int index, AbstractSparseColumn col){
    ...
    if(numColumns <= index) numColumns = index+1;
 ...
 */
  ...
  protected void addColumn(int index, int type){
    ...
    switch(type){
      case ColumnTypes.BOOLEAN: col = new SparseBooleanColumn();
			        break;
      case ColumnTypes.BYTE:    col = new SparseByteColumn();
			        break;
      case ColumnTypes.CHAR:    col = new SparseCharColumn();
			        break;
      case ColumnTypes.DOUBLE:  col = new SparseDoubleColumn();
			        break;

      case ColumnTypes.FLOAT: col = new SparseFloatColumn();
			        break;
      case ColumnTypes.BYTE_ARRAY:    col = new SparseByteArrayColumn();
			        break;
      case ColumnTypes.CHAR_ARRAY:    col = new SparseCharArrayColumn();
			        break;
      case ColumnTypes.INTEGER:  col = new SparseIntColumn();
			        break;

      case ColumnTypes.LONG:    col = new SparseLongColumn();
			        break;
      case ColumnTypes.SHORT:    col = new SparseShortColumn();
			        break;
      case ColumnTypes.OBJECT:    col = new SparseObjectColumn();
			        break;
      case ColumnTypes.STRING:  //fall through to the default...
      default:                  col = new SparseStringColumn();
			        break;
  ...
  SparseMutableTable retVal = new SparseMutableTable ();
    ...
    for(int i=0; i<cols.length; i++){
      AbstractSparseColumn currentCol = (AbstractSparseColumn) table.getColumn(cols[i]);
      retVal.setColumn(cols[i], (AbstractSparseColumn)currentCol.getSubset(indices));
    }
