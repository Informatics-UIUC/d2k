...
public class SparsePredictionTable extends SparseExampleTable implements PredictionTable {
 ...
 */
    protected void copy(SparseTable t){
...
/* Returns a reference to this table */
   ...
   *                      predictions</code>.
   */
  public int addPredictionColumn(byte[] predictions, String label, int[] indices) {
    return addPredictionColumn(new SparseByteColumn(predictions, indices), label);
  }
   ...
   *                      predictions</code>.
   */
  public int addPredictionColumn(boolean[] predictions, String label, int[] indices) {
    return addPredictionColumn(new SparseBooleanColumn(predictions, indices), label);
  }
   ...
   *                      predictions</code>.
   */
  public int addPredictionColumn(double[] predictions, String label, int[] indices) {
    return addPredictionColumn(new SparseDoubleColumn(predictions, indices), label);
  }
   ...
   *                      predictions</code>.
   */
  public int addPredictionColumn(char[] predictions, String label, int[] indices) {
    return addPredictionColumn(new SparseCharColumn(predictions, indices), label);
  }
   ...
   */
  public int addPredictionColumn(byte[][] predictions, String label, int[] indices) {
    return addPredictionColumn(new SparseByteArrayColumn(predictions, indices), label);
  }
   ...
   *                      predictions</code>.
   */
  public int addPredictionColumn(float[] predictions, String label, int[] indices) {
    return addPredictionColumn(new SparseFloatColumn(predictions, indices), label);
  }
   ...
   */
  public int addPredictionColumn(char[][] predictions, String label, int[] indices) {
    return addPredictionColumn(new SparseCharArrayColumn(predictions, indices), label);
  }
 ...
 /**
   ...
   *                      predictions</code>.
   */
  public int addPredictionColumn(Object[] predictions, String label, int[] indices) {
    return addPredictionColumn(new SparseObjectColumn(predictions, indices), label);
  }
   ...
   *                      predictions</code>.
   */
  public int addPredictionColumn(String[] predictions, String label, int[] indices) {
    return addPredictionColumn(new SparseStringColumn(predictions, indices), label);
  }
   ...
   *                      predictions</code>.
   */
  public int addPredictionColumn(short[] predictions, String label, int[] indices) {
    return addPredictionColumn(new SparseShortColumn(predictions, indices), label);
  }
   ...
   *                      predictions</code>.
   */
  public int addPredictionColumn(long[] predictions, String label, int[] indices) {
    return addPredictionColumn(new SparseLongColumn(predictions, indices), label);
  }
  ...
  public Table getSubset(int start, int len){
    ...
    retVal.predictionColumns = (SparseMutableTable) predictionColumns.getSubset(start, len);
 ...
 */
    ...
    public int[] getRowIndices(int position){
      ...
      System.arraycopy(predictions, 0, retVal, exampleIdx.length, predictions.length);
      return retVal;
    }
	...
	if (position < super.getNumColumns())
            ...
            return predictionColumns.getColumnNumEntries(position - super.getNumColumns());
    }
