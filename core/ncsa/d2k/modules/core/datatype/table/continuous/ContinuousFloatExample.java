...
public class ContinuousFloatExample implements Example, java.io.Serializable {

  ContinuousFloatExampleTable exampleSet;
  int              exampleIndex;

  public ContinuousFloatExample() {
  }

  public ContinuousFloatExample(ContinuousFloatExampleTable exampleSet, int exampleIndex) {
...
*/
  ...
  public ContinuousFloatExample shallowCopy() throws Exception {
    return (ContinuousFloatExample) this.clone();
  }

  public ContinuousFloatExample deepCopy() throws Exception {
