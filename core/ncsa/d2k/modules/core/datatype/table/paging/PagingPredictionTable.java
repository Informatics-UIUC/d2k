...
/*****************************************************************************/
   ...
   public void setColumnLabel(String l, int position) {
	  if (prediction[position])
		predictionColumnsTable.setColumnLabel(l, indirection[position]);
	  else
		((MutableTable) original).setColumnLabel(l, indirection[position]);
   }

   public void setColumnComment(String l, int position) {
	  if (prediction[position])
		 predictionColumnsTable.setColumnComment(l, indirection[position]);
	  else
		 ((MutableTable)original).setColumnComment(l, indirection[position]);
   }
   ...
   public boolean isValueMissing(int row, int column) {
	   if (prediction[column])
		  ...
		  return original.isValueMissing(row, indirection[column]);
   }
