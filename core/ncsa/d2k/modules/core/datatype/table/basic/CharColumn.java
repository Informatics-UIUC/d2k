...
final public class CharColumn extends AbstractColumn implements TextualColumn {
    ...
    /**
    	Create a new CharColumn with the specified initial capacity.
    ...
    /**
    	Create a new CharColumn with the specified data.
    ...
    /**
    	Return an exact copy of this CharColumn.  A deep copy is attempted,
    ...
    /**
    	Get the value of the bytes as an int
