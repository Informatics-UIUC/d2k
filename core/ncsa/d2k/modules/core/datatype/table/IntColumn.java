...
/**
 IntColumn is an implementation of NumericColumn which holds an int array as its internal
 representation.
 <br>
 It it optimized for: retrieval of ints by index, compact representation
 of ints,  swapping of ints, setting of ints by index, reOrder-ing by index,
 compare-ing of ints
 It is very inefficient for: removals, insertions, additions
 */
final public class IntColumn extends NumericColumn {

	static final long serialVersionUID = 7980908212710695778L;
    ...
    public Column copy () {
        ...
        try {
            ...
            newCol = new IntColumn(getCapacity());
    ...
    /**
     Get the capacity of this Column, it's potential maximum number of entries
    ...
    /**
     Suggests a new capacity for this IntColumn.  If the Column implementation supports
    ...
    public byte[] getBytes (int pos) {
        ...
        //return  ByteUtils.writeInt(internal[pos]);
    }
    ...
    public void addRow (Object newEntry) {
        ...
        newInternal[last] = ((Integer)newEntry).intValue();
        internal = newInternal;
    }
     ...
     */
    final private static int[] doSort (int[] A, int p, int r, Table t) {
        if (p < r) {
     ...
     */
    final private static int partition (int[] A, int p, int r, Table t) {
        int x = A[p];
        int i = p - 1;
        int j = r + 1;
        while (true) {
