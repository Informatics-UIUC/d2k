...
public class ReadRuleAssocPMML extends InputModule implements RulePMMLTags {
  ...
  public String getModuleInfo() {
    String s = "<p>Overview: Create a RuleTable from a PMML file."+
               "<p>Detailed Description: Parse an XML file containing a PMML "+
               "description of a rule association model.  A RuleTable "+
               ...
               "<p>Scalability: This module will create a RuleTable that stores "+
               "item sets.";
    return s;
  }
