...
public class MinEncodingLenClusterModelEvaluator
  ...
  public String getModuleName() {
    return "MEL Cluster Model Evaluator";
  }
  ...
  public void doit() throws Exception {
    try {
      ...
      if (getVerbose()){
        System.out.println("MinEncodingLenClusterModelEvaluator: Score for this model -- " + score);
      }
      ...
      System.out.println(
          "EXCEPTION: MinEncodingLenClusterModelEvaluator.doit()");
      throw ex;
    }
