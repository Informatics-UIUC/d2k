...
public abstract class Graph extends JPanel {
	...
	public Graph(VerticalTable table, DataSet[] sets, GraphSettings settings) {
		this.init (table, sets, settings);
	}

	public void init (VerticalTable table, DataSet[] sets, GraphSettings settings) {
		this.table = table;
		this.sets = sets;
	 ...
	 */
	public void setTable(VerticalTable t) {
	 ...
	 */
	static protected HashMap createUniqueValueMap(VerticalTable table, int column) {
