 ...
 *
 */
public class WEKA_J48Model extends PredictionModelModule implements Serializable, Drawable, WEKA_ModelDelegator {

  //==============
  // Data Members
  //==============

  J48 m_modelDelegate = null;

  //================
  // Constructor(s)
  //================

  public WEKA_J48Model() {
    m_modelDelegate = new J48();
  }
  ...
  */
  ...
  public String graph() throws Exception {
    if (m_modelDelegate != null) {
      return m_modelDelegate.graph();
    } else {
      return null;
    }
  }
