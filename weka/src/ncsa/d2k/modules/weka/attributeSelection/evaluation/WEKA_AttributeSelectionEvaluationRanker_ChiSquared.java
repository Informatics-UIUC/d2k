...
public class WEKA_AttributeSelectionEvaluationRanker_ChiSquared extends ComputeModule  {
  //==============
  // Data Members
  //==============
  ...
  public WEKA_AttributeSelectionEvaluationRanker_ChiSquared() {
  }
  ...
  protected void doit() throws java.lang.Exception {
    try {
      ...
      System.out.println("ERROR: WEKA_AttributeSelectionEvaluation_ChiSquared");
      throw ex;
    }
  }

  public String getModuleInfo() {
		return "<html>  <head>      </head>  <body>    A module for supplying a ChiSquared attribute rank evaluator to the     attribute selector.  </body></html>";
	}
  ...
  public boolean getMissingMerge () {
	...
	public String getModuleName() {
		return "WEKA_AttributeSelectionEvaluationRanker_ChiSquared";
	}
