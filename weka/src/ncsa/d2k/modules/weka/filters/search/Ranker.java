...
import ncsa.d2k.modules.weka.filters.evaluation.AttributeEvaluator;
import ncsa.d2k.modules.weka.filters.evaluation.UnsupervisedAttributeEvaluator;
...
public class Ranker extends ASSearch
    ...
    throws Exception
  {
    ...
    m_numAttribs = inputFeatures.length;
    ...
    m_startRange.setUpper(data.getNumColumns());
    if (!(getStartSet().equals(""))) {
    ...
    //System.out.println("numAttributes " + m_numAttribs);
    ...
    for (i = 0, j = 0; i < m_numAttribs; i++) {
      if (!inStarting(i)) {
      	m_attributeList[j++] = inputFeatures[i];
        //System.out.println("input features "  + inputFeatures[i]);
      }
    }
    ...
    for (i = 0; i < m_attributeList.length; i++) {
      ...
      //System.out.println("evaluated attribute " + m_attributeList[i]);
    }
