...
public class WEKA_ID3Model extends PredictionModelModule implements Serializable, WEKA_ModelDelegator {

  //==============
  // Data Members
  //==============

  Id3 m_modelDelegate = null;

  //================
  // Constructor(s)
  //================

  public WEKA_ID3Model() {
    m_modelDelegate = new Id3();
  }
