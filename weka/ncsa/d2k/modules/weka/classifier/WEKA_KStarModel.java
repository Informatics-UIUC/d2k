...
public class WEKA_KStarModel extends PredictionModelModule implements Serializable, WEKA_ModelDelegator {
  //==============
  // Data Members
  //==============

  KStar m_modelDelegate = null;

  //================
  // Constructor(s)
  //================

  public WEKA_KStarModel() {
    m_modelDelegate = new KStar();
  }
