...
public class DB2DBConnection extends SQLDBConnection {
   ...
   static private final long serialVersionUID = -3883833572512110916L;

   //~ Constructors ************************************************************

   /**
    * Creates a new DB2DBConnection object.
    *
    ...
    */
   public DB2DBConnection(String _url, String _driver, String _username,
                          String _password) {
...
//////////////////////////////////////////////////////////////////////////////////////////
    ...
    *  DB2 database supports Autoincrement, so SequenceName is not used. 
    *
    * @param  _tableName       <code>String</code> name of table to
    *                          create
