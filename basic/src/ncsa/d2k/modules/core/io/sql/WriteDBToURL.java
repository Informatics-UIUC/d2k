...
/**
 * Write selected fields from a relational table to a local or remote file.
 * 
 * <p><b>Note:</b> This module is the same as deprecated module <i>
 * WriteDBToFile</i>, extended to access the data through <i>
 * DataObjectProxy</i>.</p>
 *
 * @author  Hong Cheng
 * @version 1.0
...
public class WriteDBToURL extends OutputModule {
   ...
   /**
    * Write a database table data to a delimited file on filesystem or remote.
    * Delimiters
    * 		<b>  can be [ comma, space, or tab ]. 
    * <p> 
    * Inputs pulled from 
    * 
    * 	<b>this.pullInput(0) = ConnectionWrapper - open database connection
    * 	<b>this.pullInput(1) = String[]          - fields to select 
    *	<b>this.pullInput(2) = tableNames        - table name to extract data from
    *	<b>this.pullInput(3) = whereClause       - filter clause for query 
    *	<b>this.pullInput(4) = outputFileName    - name of file to write to. 
    * </p>
    * <p>Constructs SQL query statement to fetch data rows from table using the form:
    * <b>
    * 		Select Column [, ...] From table [Where ....] 
    * 	<b>fetch the rows from table, then write the results to file placing delimiter
   ...
   public String getInputInfo(int index) {
      switch (index) {
         ...
         case 4:
            return "      The Data Object Proxy to write to.   ";
         default:
   ...
   public String getModuleInfo() {
      ...
      s += "<p><b>Note:</b> This module is the same as deprecated " +
      		"module <i>WriteDBToFile</i>, extended to access the data " +
      ...
      s += "<p>Restrictions: ";
      s += "We currently only support Oracle, SqlServer, DB2, Postgres " +
