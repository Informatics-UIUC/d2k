...
public class OracleDBConnection extends SQLDBConnection {
   ...
   /**
    * Creates a new OracleDBConnection object.
    *
    ...
    */
   public OracleDBConnection(String _url, String _driver, String _username,
                             String _password) {
   ...
   /**
    * Method createSequenceQuery().
    *	
    * Create SQL Statement to construct a sequence generator for Oracle DB in the form:
    * 		Create Sequence Name startwith 1 increment by 1 nocache nomaxvalue nocycle
    * 
    * @param  seqName <code>Sting</code> name of Sequence counter to create
    *
    * @return <code>String</code> continaing a Create Sequence statement.
    * 
    * TODO: Should this object be adapted to behave like auto-incrementor in SQLServer
    * 		could be done with trigger body, could be same for other dbs that do not 
    * 		native support for Auto-Incrementer type column defination.
    */
   private String createSequenceQuery(String seqName) {

      String str =
         new String("CREATE SEQUENCE " + seqName +
   ...
   public void createTable(String tableName,
      ...
      try {
         ...
         // 2. create a sequence to act as a Primary Key for the Prediction
         // Table
   ...
   public String getFirstRowQuery(String tableName) {
      String str =
         "SELECT * FROM " + tableName + " WHERE ROWNUM < 2 /* BETWEEN 1 AND 2 */";
      return str;
   }
