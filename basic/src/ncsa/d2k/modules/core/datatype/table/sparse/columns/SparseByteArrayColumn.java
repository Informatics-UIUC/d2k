...
public class SparseByteArrayColumn extends SparseObjectColumn implements TextualColumn {
     ...
     **/
    public Column copy () {
        SparseByteArrayColumn retVal = new SparseByteArrayColumn((SparseObjectColumn)super.copy());
        return  retVal;
    }
    ...
    public Column getSubset (int pos, int len) {
        SparseByteArrayColumn subCol = new SparseByteArrayColumn((SparseObjectColumn)super.getSubset(pos,
                len));
        return  subCol;
    }
