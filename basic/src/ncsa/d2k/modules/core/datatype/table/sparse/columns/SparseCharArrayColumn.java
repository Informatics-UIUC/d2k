...
public class SparseCharArrayColumn extends SparseObjectColumn {
     ...
     **/
    public Column copy () {
        SparseCharArrayColumn retVal = new SparseCharArrayColumn((SparseObjectColumn)super.copy());
        return  retVal;
    }
    ...
    public Column getSubset (int pos, int len) {
        SparseCharArrayColumn subCol = new SparseCharArrayColumn((SparseObjectColumn)super.getSubset(pos,
                len));
        return  subCol;
    }
