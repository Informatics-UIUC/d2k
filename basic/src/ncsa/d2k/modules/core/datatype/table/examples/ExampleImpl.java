...
public class ExampleImpl extends MutableTableImpl implements Example {
	...
	public ExampleImpl(ExampleTable et, int e) {
		...
		for(int i = 0; i < inputs.length; i++) {
			...
			switch(typ) {
				case(ColumnTypes.BOOLEAN):
					c.setBoolean(et.getInputBoolean(e, i), 0);
					break;
				case(ColumnTypes.BYTE):
					c.setByte(et.getInputByte(e, i), 0);
					break;
				case(ColumnTypes.BYTE_ARRAY):
					c.setBytes(et.getInputBytes(e, i), 0);
					break;
				case(ColumnTypes.CHAR):
					c.setChar(et.getInputChar(e, i), 0);
					break;
				case(ColumnTypes.CHAR_ARRAY):
					c.setChars(et.getInputChars(e, i), 0);
					break;
				case(ColumnTypes.DOUBLE):
					c.setDouble(et.getInputDouble(e, i), 0);
					break;
				case(ColumnTypes.FLOAT):
					c.setFloat(et.getInputFloat(e, i), 0);
					break;
				case(ColumnTypes.INTEGER):
					c.setInt(et.getInputInt(e, i), 0);
					break;
				case(ColumnTypes.LONG):
					c.setLong(et.getInputLong(e, i), 0);
					break;
				case(ColumnTypes.OBJECT):
					c.setObject(et.getInputObject(e, i), 0);
					break;
				case(ColumnTypes.SHORT):
					c.setShort(et.getInputShort(e, i), 0);
					break;
				default:
					c.setString(et.getInputString(e, i), 0);
					break;
			}
			columns[colidx] = c;
			inputs[i] = colidx;
		...
		for(int i = 0; i < outputs.length; i++) {
			...
			switch(typ) {
				case(ColumnTypes.BOOLEAN):
					c.setBoolean(et.getOutputBoolean(e, i), 0);
					break;
				case(ColumnTypes.BYTE):
					c.setByte(et.getOutputByte(e, i), 0);
					break;
				case(ColumnTypes.BYTE_ARRAY):
					c.setBytes(et.getOutputBytes(e, i), 0);
					break;
				case(ColumnTypes.CHAR):
					c.setChar(et.getOutputChar(e, i), 0);
					break;
				case(ColumnTypes.CHAR_ARRAY):
					c.setChars(et.getOutputChars(e, i), 0);
					break;
				case(ColumnTypes.DOUBLE):
					c.setDouble(et.getOutputDouble(e, i), 0);
					break;
				case(ColumnTypes.FLOAT):
					c.setFloat(et.getOutputFloat(e, i), 0);
					break;
				case(ColumnTypes.INTEGER):
					c.setInt(et.getOutputInt(e, i), 0);
					break;
				case(ColumnTypes.LONG):
					c.setLong(et.getOutputLong(e, i), 0);
					break;
				case(ColumnTypes.OBJECT):
					c.setObject(et.getOutputObject(e, i), 0);
					break;
				case(ColumnTypes.SHORT):
					c.setShort(et.getOutputShort(e, i), 0);
					break;
				default:
					c.setString(et.getOutputString(e, i), 0);
					break;
			}
			columns[colidx] = c;
			outputs[i] = colidx;
