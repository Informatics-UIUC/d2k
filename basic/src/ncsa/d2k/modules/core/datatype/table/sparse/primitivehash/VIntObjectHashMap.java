...
public class VIntObjectHashMap extends TIntObjectHashMap implements VHashMap{
 ...
 /**
   ...
   */
   private VIntIntHashMap getSortedOrder(int[] validKeys, Object[] values){
     ...
     */
   private int getNewKey(Object currVal, Object[] values, int key, boolean[] ocuupiedIndices){
    int retVal = -1;
