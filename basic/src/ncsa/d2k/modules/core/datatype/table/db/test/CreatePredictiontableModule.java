...
/**
 * Creates a <code>PredictionTable</code> from an <code>ExampleTable.</code>
 *
 * @author  goren
 * @author  $Author$
...
public class CreatePredictiontableModule extends ComputeModule {
    ...
    * ExampleTable</code> input and pushes the <code>PredictionTable</code>
    * output.
    *
   ...
   public String getModuleInfo() {
      return "<p>Overview: This module creates a prediction table " +
             "from an example table.</p>";
    ...
    */
   public String getModuleName() { return "Create Prediction Table Module"; }
...
} // end class CreatePredictiontableModule
