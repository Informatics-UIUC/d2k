...
public class SparseObjectColumn extends AbstractSparseColumn {
     ...
     */
    public int getNewRow (Object currVal, Object[] values, int row, boolean[] ocuupiedIndices) {
        int retVal = -1;
        ...
        for (int i = row + 1; retVal < 0 && i < values.length && values[i].equals(currVal); i++) {
            if (!ocuupiedIndices[i]) {
                retVal = i;
            }
        }
    ...
    public int compareObjects (Object val1, Object val2) {
        ...
        if (val1 instanceof Boolean) {
            return  SparseBooleanColumn.compareBooleans(((Boolean)val1).booleanValue(),
                    ((Boolean)val2).booleanValue());
        }
        String str1, str2;
    ...
    public int compareRows (int pos1, int pos2) {
        ...
        //and comparing them.
        return  SparseStringColumn.toStringObject(obj1).compareTo(SparseStringColumn.toStringObject(obj2));
    }
    ...
    public int compareRows (Object element, int pos) {
        ...
        if (ColumnTypes.OBJECT == getType()) {
            return  SparseStringColumn.toStringObject(element).compareTo(SparseStringColumn.toStringObject(obj));
        }
