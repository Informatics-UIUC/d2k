...
// DC says change this to abstract superclass of TestTable, TrainTable.
// make a new NewSparseExampleTable that is not a subset table.
...
/*    public NewSparseExampleTable (Column[] cols) {
    ...
    public Table getSubset (int pos, int len) {
        ...
        // LAM!
        SparseExampleTable et = new SparseExampleTable(subset);
        return et;
