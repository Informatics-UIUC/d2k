...
public class RandomOptimizer extends ComputeModule implements java.io.Serializable {
	...
	public PropertyDescription[] getPropertiesDescriptions() {
		...
		pds[0] = new PropertyDescription("objectiveScoreOutputFeatureNumber", "Objective Score Output Feature Number",
				"Selects which example output feature is used to denote the objective score of the Parameter Point.  ");

		pds[1] = new PropertyDescription("objectiveScoreDirection", "Objective Score Direction",
		...
		pds[3] = new PropertyDescription("maxNumIterations", "Maximum Number of Iterations",
				"Optimization halts when this limit on the number of iterations is exceeded.  ");

		pds[4] = new PropertyDescription("randomSeed", "Random Number Generator Initial Seed",
				"This integer is use to seed the random number generator which is used to select points in parameter space.  ");

		pds[5] = new PropertyDescription("trace", "Trace",
	...
	public String getInputInfo(int i) {
		...
		case 1:
			return "The Example created by combining the Parameter Point and the objective scores";
		}
		return "";
	}

	public String[] getInputTypes() {
		String[] in = { "ncsa.d2k.modules.core.datatype.parameter.ParameterSpace", "ncsa.d2k.modules.core.datatype.table.Example" };
		return in;
	}
	...
	public String getOutputInfo(int i) {
		...
		case 2:
			return "An example table consisting of all Examples generated during optimization";
		}
		return "";
	}
	...
	public void doit() {
		...
		if (stop) {
			...
			ExampleTable optimalExampleSet = getTable(data, inputNames, outputNames, inputs, outputs, 1);
			ExampleTable exampleSet = getTable(ExampleData, inputNames, outputNames, inputs, outputs, NumExamples);
	 ...
	 * @return
	 */
	static public ExampleTable getTable(double[][] data, String[] inputNames, String[] outputNames, int[] inputs, int[] outputs,
			int count) {
