    ...
    public class TableEditorView extends TableView /* implements ItemListener */ {
        ...
        class VTCellEditor implements TableCellEditor, ActionListener {
            ...
            public Component getTableCellEditorComponent(JTable tbl, Object value, boolean isSelected, int row, int column) {
                ...
                return editor.getTableCellEditorComponent(tbl, value, isSelected, row, column);
            }
            ...
            try {
                if (selected.equals(DOUBLE_TYPE)) {
                    if (!(table.getColumnType(i) == ColumnTypes.DOUBLE)) {
                        ...
                        Column column = ColumnUtilities.toDoubleColumn(mt.getColumn(i));
                    ...
                    if (!(table.getColumnType(i) == ColumnTypes.STRING)) {
                        ...
                        // Clone the column.
                        MutableTable mt = (MutableTable) table;
                        Column column = ColumnUtilities.toStringColumn(mt.getColumn(i));
                        mt.setColumn(column, i);
                    ...
                    if (!(table.getColumnType(i) == ColumnTypes.CHAR_ARRAY)) {
                        ...
                        // Clone the column.
                        MutableTable mt = (MutableTable) table;
                        Column column = ColumnUtilities.toCharArrayColumn(mt.getColumn(i));
                        mt.setColumn(column, i);
                    ...
                    if (!(table.getColumnType(i) == ColumnTypes.FLOAT)) {
                        ...
                        // Clone the column.
                        MutableTable mt = (MutableTable) table;
                        Column column = ColumnUtilities.toFloatColumn(mt.getColumn(i));
                        mt.setColumn(column, i);
                    ...
                    if (!(table.getColumnType(i) == ColumnTypes.BOOLEAN)) {
                        ...
                        // Clone the column.
                        MutableTable mt = (MutableTable) table;
                        Column column = ColumnUtilities.toBooleanColumn(mt.getColumn(i));
                        mt.setColumn(column, i);
