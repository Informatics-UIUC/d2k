...
public class SQLRainForestOPT extends ReentrantComputeModule {
   ...
   /**
    * Creates a new SQLRainForestOPT object.
    */
      ...
      // node is a leaf
         ...
         if (best != null) {
            ...
            if (!meta.isColumnScalar(col)) {
               ...
               // below the root, corresponding to A = v
               root =
               ...
               // label, e.g. "Race=F,Yes", "Race=F,No", we need to get distinct
               ...
               for (int idx = 0; idx < distinctValues.size(); idx++) {
                  ...
                  if (newCols.length > 0) {
                     ...
                     // Switch to in-memory mode from in-database mode
                        ...
                        newNodeInfo =
                           createDataTable(dbTable, meta, newPath, subTot);
               ...
               if (
                  ...
                  // dominateRatio with parent nodes. Only generate a node if
                  // the dominateRatio improves.
   ...
   private double categoricalGain(ArrayList aPath, String column,
      ...
      // divide the information gain by the split info since sInfo could be 0 if
      // all examples have a same value in this column, add 0.000001 to it
      gain /= (sInfo + 0.000001);
   ...
   private String[] getClassValues(String classColName) {
      ...
      try {
         ...
         String classQry =
            new String("select distinct " + classColName + " from " + dbTable +
 ...
 //     String newAttrValue = " ";
   ...
   public void doit() throws Exception {
      ...
      if (meta.isColumnScalar(outputFeatures[0])) {
         ...
         if (totalRow > 0 && totalRow < modeThreshold) {
            NodeInfo aNodeInfo =
               createDataTable(dbTable, meta, splitValues,
                               totalRow);
            int[] exampleSet;
   ...
   public String getModuleInfo() {
      ...
      s +=
         "There are two implementations on RainForest. <i>SQLRainForest</i> does ";
    ...
    */
   public String getModuleName() { return "SQL Rain Forest OPT"; }
    ...
    *         specified index.
    */
   public String getOutputName(int i) { return "Decision Tree Model"; }
    ...
    *
    * @throws PropertyVetoException when i is less than or equal to zero
    */
    ...
    *
    * @throws PropertyVetoException when num is less than zero
    */
    ...
    *
    * @throws PropertyVetoException when ratio is less than zero or greater than
    *                               one
    */
