...
//		trainingSetSize = totalRow;
		...
		//inputColumnLabels = new String[inputFeatures.length];
                inputIsScalar = new boolean[inputFeatures.length];
                for(int i = 0; i < inputFeatures.length; i++) {
			//inputColumnLabels[i] = table.getColumnLabel(inputFeatures[i]);
                ...
                //for (int i=0; i<inputColumnLabels.length; i++) {
                  //System.out.println("in DFModel, col label " + i + " is " + inputColumnLabels[i]);
                //}
		//outputColumnLabels = new String[outputFeatures.length];
                outputIsScalar = new boolean[outputFeatures.length];
                for(int i = 0; i < outputFeatures.length; i++) {
			//outputColumnLabels[i] = table.getColumnLabel(outputFeatures[i]);
...
/*
	...
	public int[] getInputFeatureTypes() {
                int[] retVal = new int[inputIsScalar.length];
	...
	public int[] getOutputFeatureTypes() {
                int[] retVal = new int[outputIsScalar.length];
