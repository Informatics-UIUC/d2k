...
public class NewSQLRainForest extends SQLRainForestOPT {
   ...
   /**
    * Creates a new NewSQLRainForest object.
    */
   ...
   public double getBinNumber() { return binNumber; }
    ...
    public String getModuleInfo() {
        ...
        s +=
                "There are two implementations on RainForest. <i>NewSQLRainForest</i> does ";

        s +=
                "not do parameter optimization, but <i>NewSQLRainForestOPT<i> does.</p>";
   ...
   public class AvcSet {
    ...
    /**
     *  simple structure to hold info about a node
     */
