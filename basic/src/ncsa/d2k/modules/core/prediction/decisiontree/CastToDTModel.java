...
/**
 * Description of class CastToDTModel.
 *
 * @author  $Author$
...
public class CastToDTModel extends ComputeModule {
    ...
    */
   public String getInputInfo(int i) { return "Prediction Model"; }
    ...
    *         specified index.
    */
   public String getInputName(int i) { return "Prediction Model"; }
   ...
   public String getModuleInfo() {
      String s = "<p> Overview: ";
      s +=
         "This module converts a prediction model to a decision tree model. </p> ";
      s += "<p> Detailed Description: ";
      s +=
         "A prediction model can be created by different algorithms, for example, ";
    ...
    */
   public String getModuleName() { return "CastToDTModel"; }
    ...
    */
   public String getOutputInfo(int i) { return "Decision Tree Model"; }
