...
public final class TreeScrollPane extends JScrollPane {
    ...
    */
   public int getDepth() { return treepanel.getDepth(); }
    ...
    */
   public Printable getPrintable() { return treepanel; }
    ...
    * @return scale
    */
   public double getScale() { return treepanel.scale; }
    ...
    */
   public ViewableDTModel getViewableModel() { return treepanel.model; }
    ...
    */
   public Viewport getViewRoot() { return treepanel.viewportroot; }
   ...
   public class TreePanel extends JPanel implements MouseListener,
      ...
      void drawViewTree(Graphics2D g2, Viewport emptyview) {
         ...
         if (
             shape.intersects((emptyview.x - emptyview.width / 2), emptyview.y,
      ...
      public int findDepth(int y) {
         ...
         int depth =
            (int) (y / (scale * (viewportroot.yspace + viewportroot.height)));
      ...
      public Dimension getPreferredSize() {
         ...
         */
      public double getSHeight() { return scale * dheight; }

        /**
         * Returns scaled width of tree
         * @return scaled width
         */
      public double getSWidth() { return scale * dwidth; }
