...
/**
  Produces an IsvmModel.
This module generates a new IsvmModel and initializes it according to the
 properties, as they were set by the user (Nu parameter and number
 of input features).
 Please note that if number of input features does not match the future
 input Tables of the output model, an exception will be thrown.
...
//properties
  ...
  public int getNumAttributes(){return numAttributes;}
      ...
      public PropertyDescription[] getPropertiesDescriptions() {
        ...
        pds[1] = new PropertyDescription("numAttributes", "Number Input Features", "Number of input features in the SVM problem");
        return pds;
      }
