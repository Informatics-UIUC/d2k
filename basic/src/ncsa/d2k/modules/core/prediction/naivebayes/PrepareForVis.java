...
public class PrepareForVis extends DataPrepModule {
    ...
    */
   public String getInputInfo(int i) { return "A NaiveBayesModel module."; }
    ...
    *         specified index.
    */
   public String getInputName(int i) { return "Naive Bayes Model"; }
    ...
    */
   public String getModuleName() { return "Prepare Model for Visualization"; }
    ...
    */
   public String getOutputInfo(int i) { return "A NaiveBayesModel module."; }
    ...
    *         specified index.
    */
   public String getOutputName(int i) { return "Naive Bayes Model"; }
