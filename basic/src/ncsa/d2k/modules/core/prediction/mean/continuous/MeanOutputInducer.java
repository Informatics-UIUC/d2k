...
import ncsa.d2k.modules.core.prediction.FunctionInducer;
 ...
 * It produces a model that makes predictions that are independent of the
 * input attribute values.  During the training phase, the mean output inducer
 * sums up the output values for each output attribute and then divides by the
...
public class MeanOutputInducer extends FunctionInducer {
    ...
    */
   public String getModuleName() { return "Mean Output Inducer"; }
