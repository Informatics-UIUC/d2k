...
public class MeanOutputInducerOpt extends FunctionInducerOpt {
   ...
   public String getModuleInfo() {
      ...
      s += "<p>";
      s += "Overview: ";
      s += "This module builds a simple model by computing the average ";
      s += "for the output attribute.  </p>";
      s += "<p>";
      s += "Detailed Description: ";
      s += "The module implements the mean output learning algorithm.  ";
      s += "It produces a model that makes predictions that are independent ";
      s += "of the input attribute values.  ";
      s += "During the training phase, the mean output inducer sums up ";
      s += "the output values for each output attribute and then divides by ";
      s += "the number of examples.  ";
      s += "There are no control parameters to this learning algorithm and ";
      s += "<i>Mean Output Inducer Optimizable</i> is added for uniformity.  ";
      s += "<p>";
      s += "Restrictions: ";
      s += "This module will only classify examples with numeric output ";
      s += "attributes.";
      s += "<p>";
