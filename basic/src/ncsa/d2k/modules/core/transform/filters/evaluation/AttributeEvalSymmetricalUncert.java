...
public class AttributeEvalSymmetricalUncert extends ComputeModule{
 ...
 /** Merge missing values */
  ...
  private SymmetricalUncertAttributeEval m_eval = null;
	...
	public String getOutputName(int index) {
		switch(index) {
			case 0:
				return "SymmetricalUncertEvaluator";
			default: return "NO SUCH OUTPUT!";
		}
	}
	...
	public String getModuleInfo() {
		String s = "<p> Overview: ";
		s += "A module for supplying a Symmetrical Uncertainty attribute evaluator for the Attribute Selector module ";
		s += "</p>";
		s += "<p> Detailed Description: ";
		s += "Evaluates attributes individually by measuring symmetrical uncertainty ";
		s += "with respect to the class. Evaluates the worth of an attribute ";
		s += "by measuring the symmetrical uncertainty with respect to the class. ";
		s += "\n SymmU(Class, Attribute) = 2 * (H(Class) - H(Class | Attribute)) ";
		s += "/ H(Class) + H(Attribute).";
		s += " </p>";
	...
	public String getModuleName() {
		return "SymmetricalUncert Attribute Evaluator";
	}
   ...
   protected void doit() throws java.lang.Exception {
    try {
      ...
      System.out.println("ERROR: AttributeEvalSymmetricalUncert ");
      throw ex;
    }
  }
