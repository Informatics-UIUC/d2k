...
public class AttributeConstruction
  ...
  public String getModuleInfo() {
    ...
    sb.append(
        "new attributes in a table from operations on existing attributes.");
    ...
    sb.append(
        "attributes in the table and are used to construct new attributes. ");

    sb.append("When the GUI is dismissed, the information needed to construct ");

    sb.append(
        "these new attributes is encapsulated in a <i>Transformation</i> ");
    ...
    sb.append(
        "numeric and boolean attributes of a table. Other attributes will ");
  ...
  public Object getNewLab() {
    return _newLab;
  }

  public void setNewLab(Object value) {
    _newLab = (String[]) value;
  }

  protected int[] _newTyp = null;

  public Object getNewTyp() {
    return _newTyp;
  }

  public void setNewTyp(Object value) {
    _newTyp = (int[]) value;
  }

  protected Object[] _lastCons = null;

  public Object getLastCons() {
    return _lastCons;
  }

  public void setLastCons(Object value) {
    _lastCons = (Object[]) value;
  }
  ...
  protected class ColumnConstructionGUI
      extends JUserPane
    ...
    public void initialize() {
      ...
      addScalarButton = new JButton(new ImageIcon(mod.getImage(
      ...
      Constrain.setConstraints(leftPanel, new JLabel("              "), 0, 0, 1,
                               1,

                               GridBagConstraints.HORIZONTAL,
                               GridBagConstraints.NORTH, 0, 0);

      Constrain.setConstraints(leftPanel, new JLabel("New attribute label:"), 0,
                               0, 1, 1,
      ...
      Constrain.setConstraints(topPanel, new JSeparator(SwingConstants.VERTICAL),
                               2, 0, 1, 1,
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (src == addColumnButton) {
        ...
        if (selected != -1) {
          ...
          String label = ( ( /*AttributeTransform.*/Construction) (
              newColumnModel.elementAt(selected))).label;
    ...
    public void expressionChanged(Object evaluation) {
      ...
      if (newNameField.getText().length() == 0) {
        ...
        /*AttributeTransform.*/Construction added =
            ...
            new
            /*AttributeTransform(null).*/Construction(
  ...
  private String getHelpString() {
    ...
    sb.append(
        "Thus a given expression may involve numeric attributes or boolean ");
    ...
    sb.append(
        "the field at the top left. <b>Note carefully</b> that any characters in ");
    ...
    sb.append(
        "operators.  <b>Note:</b> Any numeric values used as the name of an attribute ");
