...
public class ChooseAttributes extends HeadlessUIModule {
    ...
    /**
     The user view class
     */
    class AttributeView extends JUserPane
        ...
        private final class StringComp
        ...
        protected boolean checkChoices () {
            if (outputList.getSelectedIndex() == -1) {
                JOptionPane.showMessageDialog(this, "You must select at least one output",
                        "Error", JOptionPane.ERROR_MESSAGE);
                return  false;
            }
            if (inputList.getSelectedIndex() == -1) {
                JOptionPane.showMessageDialog(this, "You must select at least one input",
                        "Error", JOptionPane.ERROR_MESSAGE);
                return  false;
            }
            ...
            for (int i = 0; i < selected.length; i++)
                if (ins.containsKey(selected[i])) {
                    JOptionPane.showMessageDialog(this, "You cannot select an attribute both as an input and an output",
                            "Error", JOptionPane.ERROR_MESSAGE);
                    return  false;
                }               //if contains
            return  true;
