...
/**
 * <p>
 * Title: ClusterAssignment_Props
 * </p>
 * <p>
 * Description: The Custom Properties Editor for ClusterAssignment module
 * </p>
 * <p>
...
public class ClusterAssignment_Props extends JPanel implements
		CustomModuleEditor, ActionListener, ClusterParameterDefns {
	...
	private void init() {
		...
		m_cmLbl
				.setToolTipText("Select method to use in determining similarity"
		...
		m_maxLbl
				.setToolTipText("Enter integer value > 0 specifying maximum"
						+ " number of "
		...
		m_max = new JTextField(Integer
				.toString((_src.getNumAssignments() < 1) ? 5 : _src
						.getNumAssignments()), 5);
		...
		m_dmLbl
				.setToolTipText("Select method to use in determining distance"
		...
		m_checkMV
				.setToolTipText("Check for missing values in the table of "
						+"examples.");
		...
		m_verbose
				.setToolTipText("Write verbose status information to console.");
