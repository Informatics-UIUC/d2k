...
public class Apriori extends ncsa.d2k.core.modules.ComputeModule{
	...
	*/
	public String getOutputInfo (int index) {
		switch (index) {
		    case 0:
			  String s = "A representation of the frequent itemsets found by the module. " +
...
nextrule:	        for (int ruleIndex = 0, itemIndex = 0; itemIndex < items.length; itemIndex++) {
		...
		if (showProgress || debug) {
			...
			System.out.println( getAlias()
					+ ": Identified "
					+ newSets + " frequent itemsets with "
					+ cardinality + " items that met the support criteria.");
                }
		return rules;
	}
	...
	public void doit () throws Exception {
		...
		if (documentMap == null) {
			...
			if (debug) {
				...
				System.out.println ("Apriori -> number of examples : "+numExamples);
				System.out.println ("Apriori -> cutoff : "+cutoff);
				System.out.println ("Apriori -> number of unique items : "+numItems);
				System.out.println ("Apriori -> --------------------------");
			}
