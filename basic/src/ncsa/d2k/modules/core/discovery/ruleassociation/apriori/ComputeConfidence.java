...
import ncsa.d2k.modules.core.discovery.ruleassociation.FreqItemSet;
import ncsa.d2k.modules.core.discovery.ruleassociation.ItemSets;
import ncsa.d2k.modules.core.discovery.ruleassociation.RuleTable;
 ...
 * @version 1.0
 *
 * @todo    move this to the parent package, since it is not apriori related
 *          only. fix access modifiers (from package to public, or add getter
 *          setter methods and make them protected.)
 */
public class ComputeConfidence extends ncsa.d2k.core.modules.ComputeModule {
    ...
    *
    * @throws Exception if no rules have met the minimum confidence defined by
...
// attributes. ");                               previousAttrCnt = ruleLen;
      ...
      for (int i = 0; i < numRules; i++) {
         ...
         TIntArrayList ifitem =
            new TIntArrayList(ifstmt) {
               public int hashCode() {
         ...
         TIntArrayList thenitem =
            new TIntArrayList(thenstmt) {
               public int hashCode() {
                  StringBuffer sb = new StringBuffer();
                  int[] ar = toNativeArray();
                  Arrays.sort(ar);
   ...
   public String[] getInputTypes() {
      String[] types =
      { "ncsa.d2k.modules.core.discovery.ruleassociation.ItemSets", "[[I" };
   ...
   public String getModuleName() { return "Compute Confidence"; }
   ...
   public String getOutputInfo(int outputIndex) {
      ...
      switch (outputIndex) {
         ...
         case 0:
            ...
            String s =
               "A representation of the association rules found and accepted by this module. " +
   ...
   public PropertyDescription[] getPropertiesDescriptions() {
      ...
      pds[0] =
         new PropertyDescription("confidence",
                                 "Minimum Confidence %",
    ...
    * run.
    *
    * @return Whether or not the module is ready to run. This module is ready to
    *         run when both input pipes have data in them.
    */
   ...
   public void setConfidence(double newConfidence)
      ...
      if (newConfidence <= 0.0 || newConfidence > 100) {
         throw new PropertyVetoException(" Minimum Confidence % must be greater than 0 and less than or equal to 100.",
                                         null);
      }
