...
public class FlattenMBRRecords extends InputModule {
  final int    recordSize             = -1;
  final int    bufferSize             = (int) 1e8; // must be multiple of logical record size for parallelism
  final int    gzipBufferSize         = (int) 1e6;
  final int    reportInterval         = 10000;
  
  String matrixDirectory = "c:/data/matrix/mbr/";
  ...
  public void doit() throws Exception {
    ...
    for (int fileIndex = 0; fileIndex < 1; fileIndex++) {
      ...
      String matrixName = spec.MatrixNames[0];
