...
public class PrintSSIRecords extends InputModule {
  ...
  public void setInputFeatures () {
    ...
    //  Define Input Features  //
        ...
        setInputFeature (GROUP_01, "RACE",     EQUALS_CHARACTER,  -1,   "A",   "RaceIsA?");
        setInputFeature (GROUP_01, "RACE",     EQUALS_CHARACTER,  -1,   "B",   "RaceIsB?");
        setInputFeature (GROUP_01, "RACE",     EQUALS_CHARACTER,  -1,   "H",   "RaceIsH?");
        setInputFeature (GROUP_01, "RACE",     EQUALS_CHARACTER,  -1,   "I",   "RaceIsI?");
        setInputFeature (GROUP_01, "RACE",     EQUALS_CHARACTER,  -1,   "N",   "RaceIsN?");
        setInputFeature (GROUP_01, "RACE",     EQUALS_CHARACTER,  -1,   "W",   "RaceIsW?");
        setInputFeature (GROUP_01, "RACE",     EQUALS_CHARACTER,  -1,   "O",   "RaceIsO?");
        setInputFeature (GROUP_01, "RACE",     EQUALS_CHARACTER,  -1,   "U",   "RaceIsU?");
        
        
        setInputFeature (GROUP_01, "CLM-FIL-JD", IS_NOT_ALL_ZEROS, -1,   null, "CLM-FIL-JDNotBlank?");
        setInputFeature (GROUP_01, "CLM-FIL-JD", DURATION_IN_YEARS, 100,   null, "AgeOfCLM-FIL-JD");
 
        setInputFeature (GROUP_01, "DIB-DIG",   IS_NOT_ALL_BLANKS, -1,   null, "DIB-DIGNotBlank?");
        
        setInputFeature (GROUP_01, "DIB-DIG",   SELECT_CHARACTER,  0,    null, "DIB-DIGDigit1");
        setInputFeature (GROUP_01, "DIB-DIG",   SELECT_CHARACTER,  1,    null, "DIB-DIGDigit2");
        setInputFeature (GROUP_01, "DIB-DIG",   SELECT_CHARACTER,  2,    null, "DIB-DIGDigit3");
        setInputFeature (GROUP_01, "DIB-DIG",   SELECT_CHARACTER,  3,    null, "DIB-DIGDigit4");
