...
public class GetExampleTableNumOutputs extends ComputeModule
  {

  public String getModuleInfo()
    {
    return "GetExampleTableNumOutputs";
  }
  ...
  public void doit()
    ...
    this.pushOutput(new Integer(exampleSet.getNumOutputFeatures ()), 0);
