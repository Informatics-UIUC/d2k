...
public class OldContinuousByteExampleTable extends ContinuousExampleTable implements TchengExampleTable, ExampleTable, TestTable, java.io.Serializable {
  ...
  public OldContinuousByteExampleTable() {
  }
  ...
  public OldContinuousByteExampleTable(byte[] data, int [] group, int numExamples, int numInputs, int numOutputs, String[] inputNames, String[] outputNames) {
    initialize(data, group, numExamples, numInputs, numOutputs, inputNames, outputNames);
  }

  public OldContinuousByteExampleTable(byte[] data, int numExamples, int numInputs, int numOutputs, String[] inputNames, String[] outputNames) {
    initialize(data, null, numExamples, numInputs, numOutputs, inputNames, outputNames);
  }


  public OldContinuousByteExampleTable(int numExamples, int numInputs, int numOutputs, String[] inputNames, String[] outputNames) {
  ...
  public Table copy() {
    ...
    OldContinuousByteExampleTable copy = new OldContinuousByteExampleTable();
  ...
  public Table getSubset(int rows[]) {
    ...
    OldContinuousByteExampleTable table = (OldContinuousByteExampleTable) this.copyByReference();
  ...
  public Table getTestTable() {
    ...
    OldContinuousByteExampleTable table = (OldContinuousByteExampleTable) this.copy();
  ...
  /*
  public void setExample(int e1, ExampleTable exampleSet, int e2) {
    exampleIndices[e1] = ((OldContinuousByteExampleTable) exampleSet).exampleIndices[e2];
     for (int i = 0; i < numInputs; i++)
     {
  ...
  public void addRow(double[] newEntry) {
    ...
    byte[] newData = new byte[newNumExamples * this.numFeatures];
