 ...
 * from a Logitech QuickCamPro 3000 USB camera for 10 seconds and stores
 * it on a file, named "testcam.avi". You can use the microsoft windows
 * media player to display this file.
 *
 * operating system: Windows 2000
 * required hardware:  Logitech QuickCamPro 3000
...
public class TestQuickCamPro {
  ...
  public static void main(String args[]) {
    ...
    if (!ncsa.d2k.modules.projects.dtcheng.video.DeviceInfo.setFormat(videoDataSource, captureVideoFormat)) {
