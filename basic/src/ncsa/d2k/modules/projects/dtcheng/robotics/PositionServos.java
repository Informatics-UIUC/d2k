package ncsa.d2k.modules.projects.dtcheng.robotics;
...
public class PositionServos extends OutputModule {
  ...
  static public void PositionServosToGivenAngles(double[] angles) throws Exception {
  ...
  public void doit() throws Exception {
    ...
    if (Count % ResponseRate == 0) {
      ...
      PositionServosToGivenAngles(Angles);
