...
public class RandomlySelectNextServoPositions
  ...
  public void setStepSize(double value) {
    RandomlySelectNextServoPositions.StepSize = value;
  }

  public double getStepSize() {
    return RandomlySelectNextServoPositions.StepSize;
  }
  private static double RangeOfMotion = 1.0;
  public void setRangeOfMotion(double value) {
    RandomlySelectNextServoPositions.RangeOfMotion = value;
  }

  public double getRangeOfMotion() {
    return RandomlySelectNextServoPositions.RangeOfMotion;
  }

  private static int NumServos = 4;
  public void setNumServos(int value) {
    RandomlySelectNextServoPositions.NumServos = value;
  }

  public int getNumServos() {
    return RandomlySelectNextServoPositions.NumServos;
  }
