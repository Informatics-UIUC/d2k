...
public class DeleteInputFeatures extends ComputeModule {
  ...
  public int getEndInputFeatureNumber() {return this.EndInputFeatureNumber;
   ...
   public String getModuleInfo() {
    return "DeleteInputFeatures is a module that removes a specifed subset of the input features from the example set.  " +
     "By default, the begin and end feataure number are set to -1.  Both begin and end feature number must be set to a " +
     "positive integers and the begin feature number must be less than the end feature number.";
  }
