...
public class NormalizeExamples extends ComputeModule {
  ...
  public void doit() {
    ...
    ContinuousDoubleExampleTable ContinuousExampleSet = new ContinuousDoubleExampleTable(data, numExamples, numInputs, numOutputs,
