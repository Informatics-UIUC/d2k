...
public class FlatFile
  ...
  public FlatFile(File file, String direction, int bufferSize,
        boolean readWholeLines) throws Exception {
  	String fileName = file.getPath();
    new FlatFile(fileName, direction, bufferSize, readWholeLines);
  }
  ...
  public FlatFile(File file, String direction) throws Exception {
  	String fileName = file.getPath();
    new FlatFile(fileName, direction, DefaultBufferSize, false);
  }
  ...
  public void readLine() throws Exception {
    ...
    while (true) {
      ...
      if (Buffer[localByteIndex] == QuoteByte) {
        InQuote = !InQuote;
      }
      if (!InQuote && (Buffer[localByteIndex] == DelimiterByte)) {
