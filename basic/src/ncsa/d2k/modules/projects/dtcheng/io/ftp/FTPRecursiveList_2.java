...
public class FTPRecursiveList_2 extends InputModule {
...
;
    ...
    bufferedWriter.write("cd " + "\"" + remoteDirectoryName + "\"");
    bufferedWriter.newLine();
    bufferedWriter.flush();
    ...
    searchTreeLIFO[searchTreeLIFOWriteIndex++] = remoteDirectoryName;
    allDirectoryFiles[directoryFileIndex++] = remoteDirectoryName;
