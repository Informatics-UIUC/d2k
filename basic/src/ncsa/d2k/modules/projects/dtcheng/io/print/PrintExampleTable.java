...
public class PrintExampleTable
  ...
  public PropertyDescription[] getPropertiesDescriptions() {
	...
	pds[4] = new PropertyDescription(
		"numberOfExamplesToPrint",
		"Number Of Examples To Print",
		"How many examples to report (-1 means print them all)");
  ...
  private int NumberOfExamplesToPrint = -1;
  public void setNumberOfExamplesToPrint(int value) {
	this.NumberOfExamplesToPrint = value;
  }

  public int getNumberOfExamplesToPrint() {
	return this.NumberOfExamplesToPrint;
  }
  ...
  public void doit() {
    ...
    int LocalNumberOfExamplesToPrint = NumberOfExamplesToPrint;
    
	if (LocalNumberOfExamplesToPrint == -1) {
		LocalNumberOfExamplesToPrint = numExamples;
	}

	if (LocalNumberOfExamplesToPrint > numExamples) {
		LocalNumberOfExamplesToPrint = numExamples;
	}

    if (PrintExampleValues) {
      for (int e = 0; e < LocalNumberOfExamplesToPrint; e++) {
