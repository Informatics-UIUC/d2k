...
public class Write2DMFMtoASCII extends OutputModule {

	public String getModuleName() {
		return "Write2DMFMtoASCII";
	}
	...
	public String getModuleInfo() {
		...
		"BaseFileName followed by .info.txt .<p>This has been slightly changed to work on the Linux clusters.";
	}
