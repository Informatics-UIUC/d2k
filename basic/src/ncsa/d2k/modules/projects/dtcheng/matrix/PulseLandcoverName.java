...
public class PulseLandcoverName extends ComputeModule {
	
	public String getModuleName() {
		return "PulseLandcoverName";
	}
	...
	public void doit() throws Exception {
		...
		for (int modelIndex = 0; modelIndex < nModels; modelIndex++) {
				this.pushOutput(new String("c:\\temp\\regions_scratch\\landcover_" + RegionNumber + ".txt"), 0);
				System.gc();
