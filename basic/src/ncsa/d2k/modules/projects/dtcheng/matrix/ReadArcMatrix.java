...
public class ReadArcMatrix extends InputModule {
  ...
  public String getModuleName() {
    return "ReadArcMatrix";
  }


  public String getModuleInfo() {
    return "ReadArcMatrix. This module reads in the rastor to ASCII export " +
        ...
        "have everything strung out as a column. This module just does a " +
        "direct reading resulting in a MFM with the same arrangement as the " +
        "ASCII file. Another module will read it directly into a column.";
  }
  ...
  public void doit() throws Exception {
    ...
    double NoDataValue;
    {
      ...
      System.out.println("ReadArcMatrix filename = " + DataPath);

      rio.readLine();
      string = new String(buffer, rio.LineStart + offset, rio.LineEnd - rio.LineStart - offset);
      ncols = (long) Double.parseDouble(string);
      System.out.println("ncols = " + ncols);

      rio.readLine();
      string = new String(buffer, rio.LineStart + offset, rio.LineEnd - rio.LineStart - offset);
      nrows = (long) Double.parseDouble(string);
