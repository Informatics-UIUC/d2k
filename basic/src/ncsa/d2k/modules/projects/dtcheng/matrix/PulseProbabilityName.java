...
public class PulseProbabilityName extends ComputeModule {
	
	public String getModuleName() {
		return "PulseProbabilityName";
	}
	...
	public void doit() throws Exception {
		...
		for (int modelIndex = 0; modelIndex < nModels; modelIndex++) {
				this.pushOutput(new String("c:\\temp\\regions_scratch\\d2k_out\\prob_" + RegionNumber + "_" + modelIndex), 0);
				System.gc();
				Thread.sleep(sleepTime);
				this.pushOutput(new String("c:\\temp\\regions_scratch\\d2k_out\\scenario_prob" + RegionNumber + "_" + modelIndex), 0);
				System.gc();
				Thread.sleep(sleepTime);
		}
