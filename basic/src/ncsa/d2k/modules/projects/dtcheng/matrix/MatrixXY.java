  ...
  public void doit() throws Exception {
    ...
    if (XIsScalar && YIsScalar) {
      ...
      if (XIsScalar) {
        ...
        for (long RowIndex = 0; RowIndex < RowSizeY; RowIndex++) {
          for (long ColIndex = 0; ColIndex < ColSizeY; ColIndex++) {
        ...
        if (YIsScalar) {
          ...
          ResultMatrix = new MultiFormatMatrix(FormatIndex, new long[] {RowSizeX, ColSizeY});
