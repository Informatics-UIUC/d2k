...
// determine the proper format
    long NumElements = nWeights + NNDeltas.getDimensions()[0];
...
//        System.out.println("WeightIndex = " + WeightIndex);
        NeuronFrom = (long)WeightNumberFromToNeuronTable.getValue(WeightIndex,0);
        NeuronTo = (long)WeightNumberFromToNeuronTable.getValue(WeightIndex,1);
