...
public class NNHessianNoHiddenLayersCondensedInts extends ComputeModule {

    public String getModuleName() {
        return "NNHessianNoHiddenLayersCondensedInts";
    }

    public String getModuleInfo() {
        return "This is the same as the original, just it uses integer arrays for the reference tables... <p>" 
...
public void doit() throws Exception {
	    ...
	    MultiFormatMatrix RawSerializedWeights = (MultiFormatMatrix)this.pullInput(2);
	    MultiFormatMatrix RawBiases = (MultiFormatMatrix)this.pullInput(3);
	    int[][] LayerTable = (int[][])((int[][])this.pullInput(4)).clone();
	    int[][] WeightNumberFromToNeuronTable = (int[][])((int[][])this.pullInput(5)).clone();
