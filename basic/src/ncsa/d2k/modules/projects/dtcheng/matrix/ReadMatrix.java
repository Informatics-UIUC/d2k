...
public class ReadMatrix
  ...
  private long NumRowsToRead = 60;
  public void setNumRowsToRead(long value) {
    this.NumRowsToRead = value;
  }

  public long getNumRowsToRead() {
  ...
  public String getModuleInfo() {
    return "ReadContinuousExampleTable; the number of columns is limited to that which can be denoted by an int.";
  }
  ...
  public void doit() throws Exception {
    ...
    long numExamples = (long)NumRowsToRead;
...
//    double[] data = new double[(int)numExamples * numFeatures];
    ...
    for (long e = 0; e < NumRowsToRead; e++) {
      ...
      for (int f = 0; f < numColumns; f++) {
        if (inputColumnSelected[f]) {
          ...
          exampleSet.setValue(e, (long)InputIndex, value);
          InputIndex++;
        }
      }
    }
