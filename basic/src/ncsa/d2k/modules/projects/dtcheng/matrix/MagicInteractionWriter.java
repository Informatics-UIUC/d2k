...
public class MagicInteractionWriter extends OutputModule {
  
  public String getModuleName() {
    return "MagicInteractionWriter";
  }
  
  public String getModuleInfo() {
    return "This module attempts to write a 2-d matrix to disk ascii style and a whole bunch of magic to make a 2-d island. and does the 4th order interactions";
  }
  ...
  public void doit() throws Exception {
    ...
    for (long RowIndex = 0; RowIndex < NumRows; RowIndex++) {
      ...
      outWriterObject.print(
          xxx + DelimiterString + yyy + DelimiterString +
          xxx*xxx + DelimiterString + xxx*yyy + DelimiterString + yyy*yyy + DelimiterString +
          xxx*xxx*xxx + DelimiterString + xxx*xxx*yyy + DelimiterString + xxx*yyy*yyy + DelimiterString + yyy*yyy*yyy + DelimiterString +
          xxx*xxx*xxx*xxx + DelimiterString + xxx*xxx*xxx*yyy + DelimiterString + xxx*xxx*yyy*yyy + DelimiterString + xxx*yyy*yyy*yyy + DelimiterString + yyy*yyy*yyy*yyy + DelimiterString +
          onIsland + "\n");
    }
