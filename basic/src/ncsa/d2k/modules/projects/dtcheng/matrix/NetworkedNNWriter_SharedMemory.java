...
public class NetworkedNNWriter_SharedMemory extends OutputModule {
	
	public String getModuleName() {
		return "NetworkedNNWriter_SharedMemory";
	}
	
	public String getModuleInfo() {
		return "This is for use with a shared memory machine. Thus, no machine list is necessary."
...
//		NewItineraryWriter.println("<!-- The machine assignments would go here, but we are running everything local -->");
