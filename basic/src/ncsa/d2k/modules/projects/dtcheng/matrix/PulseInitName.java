...
public class PulseInitName extends ComputeModule {
	
	public String getModuleName() {
		return "PulseInitName";
	}
...
//		int nRegions = 4;
		...
		for (int modelIndex = 0; modelIndex < nModels; modelIndex++) {
				this.pushOutput(new String("c:\\temp\\regions_scratch\\parameters\\NN_inits_" + modelIndex + ".txt"), 0);
				System.gc();
