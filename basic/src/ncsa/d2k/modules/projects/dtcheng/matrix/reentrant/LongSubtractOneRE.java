...
public class LongSubtractOneRE extends OrderedReentrantModule {

	public String getModuleInfo() {
		return "LongSubtractOne: takes a Long and bumps the value down by one. Reentrant Version";
	}

	public String getModuleName() {
		return "LongSubtractOneRE";
	}
