...
public class ReadNNInitializationFile extends InputModule {
	...
	public void doit() throws Exception {
		...
		long nExplanatoryVariables = (long) Long.parseLong(LineContents);
...
*/					
		...
		LineContents = InitReader.readLine();
		long nOptionsMinusOne = (long) Long.parseLong(LineContents);

		LineContents = InitReader.readLine();
		long nElementsThreshold = (long) Long.parseLong(LineContents);

		LineContents = InitReader.readLine();
		double FractionInTraining = (double) Double.parseDouble(LineContents);

		LineContents = InitReader.readLine();
		double LearningRateTemp = (double) Double.parseDouble(LineContents);
		...
		LineContents = InitReader.readLine();
		long nEpochs = (long) Long.parseLong(LineContents);

		LineContents = InitReader.readLine();
		long CheckNumber = (long) Long.parseLong(LineContents);
