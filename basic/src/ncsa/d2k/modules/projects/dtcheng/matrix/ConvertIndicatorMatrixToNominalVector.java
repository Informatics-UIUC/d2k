...
public class ConvertIndicatorMatrixToNominalVector
  ...
  public void doit() throws Exception {
    ...
    long NumRows = IndicatorMatrix.getDimensions()[0];
    long NumCols = IndicatorMatrix.getDimensions()[1];

    MultiFormatMatrix NominalVector = new MultiFormatMatrix(FormatIndex, new long [] {NumRows, 1});
