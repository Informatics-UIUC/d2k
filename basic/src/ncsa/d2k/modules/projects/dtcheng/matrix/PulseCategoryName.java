...
public class PulseCategoryName extends ComputeModule {
	
	public String getModuleName() {
		return "PulseCategoryName";
	}
...
//		int nRegions = 4;
		...
		for (int modelIndex = 0; modelIndex < nModels; modelIndex++) {
				this.pushOutput(new String("c:\\temp\\regions_scratch\\d2k_out\\cat_" + RegionNumber + "_" + modelIndex), 0);
				System.gc();
				Thread.sleep(sleepTime);
				this.pushOutput(new String("c:\\temp\\regions_scratch\\d2k_out\\scenario_cat" + RegionNumber + "_" + modelIndex), 0);
				System.gc();
				Thread.sleep(sleepTime);
		}
