...
public class ApplyFunctionInducerWithBoosting
  ...
  public void doit() throws Exception {
    ...
    ErrorFunction InputErrorFunction = (ErrorFunction)this.pullInput(1);
    ...
    for (int i = 0; i < NumberOfRounds; i++) {
      ...
      model = FunctionInducer.generateModel(examples, InputErrorFunction);
      ...
      for (int e = 0; e < numExamples; e++) {
        ...
        errorSum += InputErrorFunction.evaluate(OriginalExamples, e, predictionTable, predictedOutputs, BoostedModel);
      ...
      synchronized (System.out) {
        if (examples.getLabel() != null)
          System.out.println("(" + examples.getLabel() + ")" +
                             ErrorFunction.getErrorFunctionName(InputErrorFunction.index) + " = " + utility[0]);
        else
          System.out.println(ErrorFunction.getErrorFunctionName(InputErrorFunction.index) + " = " + utility[0]);
      }
