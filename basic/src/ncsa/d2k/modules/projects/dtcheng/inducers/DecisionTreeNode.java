...
public class DecisionTreeNode implements java.io.Serializable /*, ScalarViewableDTNode */ {
  ...
  public ExampleTable examples;
  public Model model;
  Decomposition decomposition;
  DecisionTreeNode root = null;
  DecisionTreeNode parent = null;
  public DecisionTreeNode childNode1 = null;
  public DecisionTreeNode childNode2 = null;
  double error;
  ...
  public ViewableDTNode getViewableChild(int i) {
    if (i == 0)
      return null /* !!! this.childNode2*/;
    else
    if (i == 1)
      return null /* !!! this.childNode1 */;
    else
      return null;
