...
public class ErrorFunctionGenerator extends ComputeModule {
  ...
  public PropertyDescription [] getPropertiesDescriptions() {
    ...
    pds[0] = new PropertyDescription("errorFunctionName", "Error Function", "The name of the error function, can be Absolute, Classification, Likelihood, Variance, or Relative.");
    return pds;
  }
  ...
  public String getModuleInfo() {
    ...
    " values.  Relative error is absolute error divided by the acutal value.    </p>";
  }
  ...
  class SetErrorFunction extends JPanel implements CustomModuleEditor {
    final String [] errors = {"Absolute","Classification","Likelihood","Variance","Relative", "NeuroPace1", "NeuroPace2"};
