...
public class BandPassEnergyTransformation extends ComputeModule implements Serializable {
  ...
  public void setNumTimeSlices(int value) {
  ...
  public void setValueFactor(double value) {
    this.ValueFactor = value; }
  public double getValueFactor() {
    return this.ValueFactor; }
  
  private double KeneticWeight = 1.0;
  public void setKeneticWeight(double value) {
    this.KeneticWeight = value; }
  public double getKeneticWeight() {
    return this.KeneticWeight; }
  
  private double PotentialWeight = 1.0;
  public void setPotentialWeight(double value) {
    this.PotentialWeight = value; }
  public double getPotentialWeight() {
    return this.PotentialWeight; }
  ...
  */
        ...
        values[s * NumBands + b] = (KeneticWeight * keneticEnergySums[b] + PotentialWeight * potentialEnergySums[b]) * ValueFactor;
      }
    }
