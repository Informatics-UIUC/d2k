 ...
 *
 */
package ncsa.d2k.modules.deprecated.core.prediction.svm;
...
public class MergeSVMProblems extends ncsa.d2k.core.modules.DataPrepModule {
   ...
   private svm_problem merge(svm_problem newData, svm_model oldModel) {
      ...
      svm_node[][] sv = new svm_node[0][];
      //the following code is not supported in 2.83 version of libsvm...
         // copy(svm.svm_get_support_vectors(oldModel)); // the support vectors.
