 ...
 */
/*
 * Created on Dec 14, 2004 Copyright 2004 University of Illinois Board of
 * Trustees.
 */
package ncsa.d2k.modules.deprecated.core.control;

import ncsa.d2k.core.modules.OutputModule;


/**
 * Read input and discard. <b>This module is deprecated.</b>
 *
 * @author  redman
...
public class Sink extends OutputModule {
   ...
   /**
    * Performs the main work of the module. Pull one input, and do nothing.
    *
   ...
   public String getInputInfo(int index) {
      ...
      switch (index) {
         ...
         case 0:
            return "This is the object to be trashed. ";
